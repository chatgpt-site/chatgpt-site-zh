# 国内 中文版 ChatGPT 镜像网站整理汇总（2024/11/23）
## chatgpt 镜像网站 项目介绍
在这里汇总整理了多个国内 ChatGPT-4 中文版镜像网站，帮助用户在正常网络下也能访问 GPT。

## 什么是chatgpt镜像站
**chatgpt镜像网站**（Mirror Site）是指通过复制原始网站内容和结构，创建的备用网站。其主要目的是在原始网站无法访问时，提供相同或类似的服务和信息。
